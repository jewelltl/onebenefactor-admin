...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: '/assets/images/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: '/assets/images/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: 'assets/images/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: 'assets/images/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: 'assets/images/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'assets/images/avatars/6.jpg', status: 'danger' },
